#!/bin/bash
# instaBRUTAL created by phoenixfyre.codez 
# the phoenixforce is not liable for any damages done by the potential users of this program 
...
python welcome.py
figlet -f mini "instaBRUTAL"
python intro.py

function start() {
python uname.py
read -p $'\e[1;92m: \e[0m' user
